...
export default {
	...
	methods: {
		setData() {
          ...
          this.firstName = appConfig.item.from.first_name;
          this.lastName = appConfig.item.from.last_name;
          this.username = appConfig.item.from.username;
          this.email = appConfig.item.from.email;
